...
parser.add_argument('--visualize_path', default='./visualize_refine',
                    help='save checkpoint path')                    
...
first_network = ResNet360(in_channels=3)
second_network = ResNet360(in_channels=4)
...
def train(rgb, depth, mask, batch_idx):
    ...
    optimizer.zero_grad()
    # Loss -------------------------------------------- 
    coarse_output = first_network(rgb)
